    ...
    <section className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          type="button"
          onClick={exportCsv}
          className="border border-[#EDE9E0]/25 px-4 py-2 text-xs uppercase tracking-[0.16em] text-[#EDE9E0]/85 hover:border-[#EDE9E0]/45"
        >
          Export CSV
        </button>
      </div>
      ...
      <input
        ...
        className="w-full border border-[#EDE9E0]/20 bg-[#080808] px-3 py-2 text-sm"
      />

      <div className="overflow-x-auto border border-[#EDE9E0]/15 bg-[#080808] p-3">
        <table className="min-w-full text-left text-sm md:min-w-[1100px]">
          <thead className="text-[11px] uppercase tracking-[0.16em] text-[#EDE9E0]/55">
            <tr>
          ...
          <tbody>
            {filtered.map((customer) => (
              <tr key={customer.phone} className="border-t border-[#EDE9E0]/10">
                ...
                <td className="py-3">
                  <button
                    ...
                    className="border border-[#EDE9E0]/20 px-3 py-1 text-xs uppercase tracking-[0.14em]"
                  >
                    View
                  </button>
                </td>
      ...
      {selected ? (
        <aside className="border border-[#EDE9E0]/15 bg-[#080808] p-4">
          <div className="mb-3 flex items-center justify-between">
            <h3 className="text-sm uppercase tracking-[0.16em] text-[#EDE9E0]/75">
              Customer Detail
            </h3>
            <button
              type="button"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2 text-sm">
              <p>
                <span className="text-[#EDE9E0]/55">Name:</span> {selected.name}
              </p>
              <p>
                <span className="text-[#EDE9E0]/55">Phone:</span>{" "}
                {selected.phone}
              </p>
              <p>
                <span className="text-[#EDE9E0]/55">Total spent:</span>{" "}
                {formatEGP(selected.totalSpent)}
              </p>
              <p>
                <span className="text-[#EDE9E0]/55">Average order value:</span>{" "}
                {formatEGP(selected.averageOrderValue)}
              </p>
              <p>
                <span className="text-[#EDE9E0]/55">Preferred payment:</span>{" "}
                {selected.preferredPayment}
              </p>
              <p>
                <span className="text-[#EDE9E0]/55">Sizes ordered:</span>{" "}
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block border border-[#EDE9E0]/20 px-3 py-1 text-xs uppercase tracking-[0.14em]"
              >
                WhatsApp
              </a>
            </div>
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.14em] text-[#EDE9E0]/55">
                Addresses Used
              </p>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 overflow-x-auto">
              <table className="min-w-full text-left text-sm">
                <thead className="text-[11px] uppercase tracking-[0.14em] text-[#EDE9E0]/55">
                  <tr>
          ...
          <div className="mt-4">
            ...
            {selected.notes.length ? (
              ...
              <p className="mt-2 text-sm text-[#EDE9E0]/55">No notes.</p>
            )}
          </div>
        </aside>
      ) : null}
