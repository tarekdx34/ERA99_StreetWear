            ...
            return (
              <Link
                ...
                className={`mb-1 flex items-center gap-3 border-l-2 px-3 py-3 text-xs font-medium uppercase tracking-[0.16em] transition-colors duration-200 ${
                  active
                    ? "border-l-[#8B0000] bg-[#1A1A1A] text-[#F0EDE8]"
              ...
              >
                ...
                {item.hasPending && pendingOrdersCount > 0 ? (
                  <span className="ml-auto min-w-5 bg-[#8B0000] px-1 py-[2px] text-center text-[10px] leading-none text-[#F0EDE8]">
                    {pendingOrdersCount}
                  </span>
                ) : null}
              </Link>
        ...
        <header className="sticky top-0 z-30 flex h-16 min-h-16 items-center justify-between border-b border-[#F0EDE8]/10 bg-[#080808] px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Bell size={16} />
              {unreadCount > 0 ? (
                <span className="absolute -right-2 -top-2 min-w-4 bg-[#8B0000] px-1 text-[10px] leading-4 text-[#F0EDE8]">
                  {unreadCount}
                </span>
              ) : null}
            </button>
