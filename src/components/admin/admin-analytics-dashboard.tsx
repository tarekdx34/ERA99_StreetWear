  ...
  return (
    <section className="space-y-6 md:space-y-8">
      ...
      <section className="space-y-3 md:space-y-4">
        ...
        <div className="grid gap-4 xl:grid-cols-[2fr_1fr]">
          <article className="border border-[#EDE9E0]/15 bg-[#080808] p-4">
            ...
            <div className="h-[240px] min-w-0 md:h-[280px]">
          ...
          <article className="border border-[#EDE9E0]/15 bg-[#080808] p-4">
            ...
            <div className="mt-4 space-y-3 text-sm">
              <p className="flex items-center justify-between border-b border-[#EDE9E0]/10 pb-2">
          ...
          <article className="border border-[#EDE9E0]/15 bg-[#080808] p-4">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {data.products.lowStockAlerts.length === 0 ? (
                <li className="text-[#EDE9E0]/55">No low stock items.</li>
              ) : (
                data.products.lowStockAlerts.map((item: any) => (
                  ...
                  >
                    <span>{item.name}</span>
                    <span className="text-[#EDE9E0]/70">{item.stock}</span>
                  </li>
                ))
              )}
            </ul>
          ...
          <article className="border border-[#EDE9E0]/15 bg-[#080808] p-4">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {data.products.outOfStock.length === 0 ? (
                <li className="text-[#EDE9E0]/55">No out of stock items.</li>
              ) : (
                data.products.outOfStock.map((item: any) => (
                  ...
                  >
                    <span>{item.name}</span>
                    <span className="text-[#EDE9E0]/70">0</span>
                  </li>
                ))
              )}
            </ul>
            <p className="mt-3 text-xs uppercase tracking-[0.12em] text-[#EDE9E0]/60">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 xl:grid-cols-3">
          <article className="border border-[#EDE9E0]/15 bg-[#080808] p-4 xl:col-span-1">
            <p className="text-xs uppercase tracking-[0.16em] text-[#EDE9E0]/65">
          ...
          <article className="min-w-0 border border-[#EDE9E0]/15 bg-[#080808] p-4 xl:col-span-1">
            <p className="text-xs uppercase tracking-[0.16em] text-[#EDE9E0]/65">
            ...
            <div className="h-[220px] min-w-0 md:h-[260px]">
              ...
              >
                <BarChart data={data.customers.preferenceByGovernorate}>
                  ...
                  <Bar dataKey="online" stackId="a" fill="#555555" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </article>
