        ...
        <>
          ...
          >
            <div className="mb-6 flex items-center justify-between border-b border-[#F0EDE8]/15 pb-4">
              ...
              <button
                onClick={closeCart}
                className="border border-[#F0EDE8]/25 p-2 hover:border-[#F0EDE8]"
              >
                <CloseIcon />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {items.length === 0 ? (
                <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
                  <p className="text-sm text-[#F0EDE8]/75">
                    Your cart is empty
                  </p>
                  <Link
                    href="/shop"
                ...
                <div className="space-y-4">
                  {items.map((item) => {
                    ...
                    return (
                      <article
                        key={key}
                        className="border border-[#F0EDE8]/12 p-3"
                      >
                        <div className="grid grid-cols-[60px_1fr_auto] gap-3">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-[11px] text-[#F0EDE8]/65">
                              {item.color} / {item.size}
                            </p>
                            <div className="mt-2 inline-flex items-center border border-[#F0EDE8]/25">
                              <button
                                className="h-7 w-7 border-r border-[#F0EDE8]/25"
                              ...
                              <button
                                className="h-7 w-7 border-l border-[#F0EDE8]/25"
                                onClick={() => updateQty(key, item.qty + 1)}
                              >
                                <PlusIcon />
                              </button>
                          ...
                          <div className="flex flex-col items-end justify-between">
                            <button
                              ...
                              className="text-[#F0EDE8]/55 hover:text-[#F0EDE8]"
                            >
                              ×
                            </button>
                            <p className="text-xs">
            ...
            <div className="mt-4 border-t border-[#F0EDE8]/15 pt-4">
              ...
              <p className="mb-4 text-xs text-[#F0EDE8]/55">
